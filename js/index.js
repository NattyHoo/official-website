...
window.onload = function () {
    ...
    if (activeName == 'about.html' || activeName == 'feedback.html') {
    } else {
    ...
    switch (activeName) {
        case 'product':
            for (var i = 0; i < $('.ul li').length; i++) {
                if ($('.ul li').eq(i).attr("name") == 'product') {
                    $('.ul li').eq(i).addClass('active').siblings('li').removeClass('active')
                }
            }
            ;
            break;
        case 'support':
            for (var i = 0; i < $('.ul li').length; i++) {
                if ($('.ul li').eq(i).attr("name") == 'support') {
                    $('.ul li').eq(i).addClass('active').siblings('li').removeClass('active')
                }
            }
            ;
        ...
        case 'about.html':
            for (var i = 0; i < $('.ul li').length; i++) {
                if ($('.ul li').eq(i).attr("name") == 'about.html') {
                    $('.ul li').eq(i).addClass('active').siblings('li').removeClass('active')
                }
            }
            ;
        ...
        case 'feedback.html':
            for (var i = 0; i < $('.ul li').length; i++) {
                if ($('.ul li').eq(i).attr("name") == 'feedback.html') {
                    $('.ul li').eq(i).addClass('active').siblings('li').removeClass('active')
                }
            }
            ;
    ...
    $('.header>ul>li').hover(
        function () {
            $(this).find('.childUl').fadeIn(100);
            $(this).find('.childUl').animate({top: '80px', display: 'block'}, 200)
        },
        function () {
            $(this).find('.childUl').animate({top: '100px', display: 'none'}, 200);
            $(this).find('.childUl').fadeOut();
        }
    )
...
var getPathParams = function (variable) {
